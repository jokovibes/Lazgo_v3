    ...
    <div className="min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="flex justify-center mb-8">
          <div className="flex space-x-2 p-1 bg-blue-800/30 dark:bg-white/5 rounded-lg border border-white/10">
            <TabButton label="Rekam Harian" isActive={activeTab === 'daily'} onClick={() => setActiveTab('daily')} icon={<RecapIcon className="w-4 h-4" />} />
            <TabButton label="Analisis Bulanan" isActive={activeTab === 'monthly'} onClick={() => setActiveTab('monthly')} icon={<SummaryIcon className="w-4 h-4" />} />
            <TabButton label="Database Siswa" isActive={activeTab === 'database'} onClick={() => setActiveTab('database')} icon={<DatabaseIcon className="w-4 h-4" />} />
          </div>
        </div>
